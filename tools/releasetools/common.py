...
class BlockDifference(object):
  ...
  def WriteScript(self, script, output_zip, progress=None,
    ...
    if not self.src:
      ...
      script.Print(" ")
      script.Print("Flashing Bliss %s partition..." % (self.partition,))
    else:
      script.Print(" ")
      script.Print("Flashing Bliss %s partition after verification." % (self.partition,))
  ...
  def WritePostInstallVerifyScript(self, script):
    partition = self.partition
    script.Print(" ")
    script.Print('Verifying Bliss %s files...' % (partition,))
    ...
    if self.tgt.extended:
      ...
      script.Print(" ")
      script.Print('Verified Bliss %s partition.' % (partition,))
      if partition == "system":
